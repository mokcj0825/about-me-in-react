...
interface Props {
  ...
  /** The highlight type for this cell */
  highlight?: 'selection' | 'effect';
  
  /** Whether this cell is selectable for weapon selection range */
  isSelectable?: boolean;
  
  /** Whether this cell is effectable for weapon effect area */
  isEffectable?: boolean;
}
...
export const HexCell: React.FC<Props> = ({
  ...
  // Determine the highlight type with proper priority
  const getHighlightType = (): 'moveable' | 'zoc' | 'selection' | 'effect' | undefined => {
